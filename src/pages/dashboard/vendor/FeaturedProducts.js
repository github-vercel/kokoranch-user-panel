...
function FeaturedProducts({ setSidebar, sidebar }) {
  ...
  const getAllFeaturedItems = async () => {
    try {
      ...
      setLoader(true);
      const res = await GET(
        "/products/my-products?type=featured",
        storageToken
      );
      console.log(res, "products/my-products?type=featured");
      let arr = [...res?.data];
      setLoader(false);
      setRowData(arr);
        ...
        >
          <div>
            ...
            <div style={{ marginTop: "20px", color: "white" }}>
              ...
              >
                <h3 style={{ marginLeft: "20px" }}>Featured Products</h3>
